...
import org.jetbrains.letsPlot.core.plot.builder.scale.DefaultMapperProviderUtil.createColorMapperProvider
import org.jetbrains.letsPlot.core.plot.builder.scale.DefaultMapperProviderUtil.createObjectIdentity
import org.jetbrains.letsPlot.core.plot.builder.scale.DefaultMapperProviderUtil.createStringIdentity
import org.jetbrains.letsPlot.core.plot.builder.scale.DefaultMapperProviderUtil.createWithDiscreteOutput
...
object DefaultMapperProvider {
    ...
    private class TypedMapperProviderMap internal constructor() {
        ...
        init {
            ...
            this.put(VALUE, NUMERIC_IDENTITY)
